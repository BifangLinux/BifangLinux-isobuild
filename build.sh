...
iso_name=bifanglinux
iso_label="BIFANG$(date +%y%m)"
iso_publisher="BifangLinux <https://bifanglinux.github.io>"
iso_application="BifangLinux Live Kit"
...
# Build ISO
make_iso() {
    out_filename="Bifanglinux-$(date +%y%m)_x86_64.iso"
